...
namespace Bytes2you.Validation.UnitTests.ValidationPredicates.StringPredicates.StringNotNullOrWhiteSpaceValidationPredicateTests
{
    ...
    public class Instance_Should
    {
        ...
        {
            // Assert.
            Assert.IsNotNull(StringNotNullOrWhiteSpaceValidationPredicate.Instance);
        }
        ...
        public void ReturnOneAndTheSameInstance()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                Assert.AreSame(StringNotNullOrWhiteSpaceValidationPredicate.Instance, StringNotNullOrWhiteSpaceValidationPredicate.Instance);
            }
        }
    }
}
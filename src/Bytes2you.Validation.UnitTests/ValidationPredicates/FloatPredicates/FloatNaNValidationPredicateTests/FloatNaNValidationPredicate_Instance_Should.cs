...
{
    [TestClass]
    public class FloatNaNValidationPredicate_Instance_Should
    {
        [TestMethod]
        public void ReturnNotNull()
        {
            // Assert.
            Assert.IsNotNull(FloatNaNValidationPredicate.Instance);
        }
        ...
        public void ReturnOneAndTheSameInstance()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                Assert.AreSame(FloatNaNValidationPredicate.Instance, FloatNaNValidationPredicate.Instance);
            }
        }
    }
}
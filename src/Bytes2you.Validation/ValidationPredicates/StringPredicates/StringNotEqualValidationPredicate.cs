...
{
    internal class StringNotEqualValidationPredicate : BoundedArgumentValidationPredicate<string>
    {
        private readonly StringComparison comparisonType;

        public StringNotEqualValidationPredicate(string bound, StringComparison comparisonType)
            : base(bound)
        {
